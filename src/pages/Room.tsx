...
export function Room() {
  ...
  async function handleSendQuestion(event: FormEvent) {
    ...
    if (!user) {
      throw new Error('Tienes que realizar Login')
    }
        ...
        <form onSubmit={handleSendQuestion}>
          ...
          <div className="form-footer">
            { user ? (
              ...
              <span>Para enviar una pregunta, <button>Realize Login</button>.</span>
            ) }
            
            <Button type="submit" disabled={!user}>Enviar pregunta</Button>
          </div>
        </form>
